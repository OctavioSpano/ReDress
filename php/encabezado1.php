...
<div class="row">
        <div class="col s4 l1">
            <a href="buscado1.php" class="waves-effect waves-light btn">Remeras</a>
<!--            <a href="buscado1.php">
            <img id="btn_remera"src="../imagenes/Boton Remera.png">
          </a>-->
        </div>
        <div class="col s4 l1">
            <a href="buscado1.php" class="waves-effect waves-light btn">Pantalones</a>
<!--            <a href="buscado1.php">
...
!-->
<div id="publicarbtn" >
      <a href="publicar.php" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
